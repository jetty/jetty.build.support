...
public class RequireOsgiCompatibleVersionRuleTest
{
    ...
    @Test
    public void testTooLongOsgiVersion()
        throws EnforcerRuleException
    {
    ...
    @Test
    public void testTooShortOsgiVersion()
        throws EnforcerRuleException
    {
        Assertions.assertThrows( EnforcerRuleException.class, () -> {
            RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testIgnoredSnapshotOsgiVersion()
        throws EnforcerRuleException
    {
        RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testLettersInPartOneOsgiVersion()
        throws EnforcerRuleException
    {
        Assertions.assertThrows( EnforcerRuleException.class, () -> {
            RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testLettersInPartOneAOsgiVersion()
        throws EnforcerRuleException
    {
        Assertions.assertThrows( EnforcerRuleException.class, () -> {
            RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testLettersInPartTwoOsgiVersion()
        throws EnforcerRuleException
    {
        Assertions.assertThrows( EnforcerRuleException.class, () -> {
            RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testBetaOsgiVersion()
        throws EnforcerRuleException
    {
        Assertions.assertThrows( EnforcerRuleException.class, () -> {
            RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testAlphaOsgiVersion()
        throws EnforcerRuleException
    {
        Assertions.assertThrows( EnforcerRuleException.class, () -> {
            RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
    ...
    @Test
    public void testGoodSnapshotOsgiVersion()
        throws EnforcerRuleException
    {
        RequireOsgiCompatibleVersionRule rule = new RequireOsgiCompatibleVersionRule();
        rule.ensureValidOsgiVersion( "7.0.2.SNAPSHOT" );
